...
our %FIELDS = (
    ...
    'Bugs' => {
        allowed => (ALL_PKG | CTRL_INFO_SRC) & (~CTRL_INFO_PKG),
    },
    'Build-Conflicts' => {
        allowed => ALL_SRC,
        dependency => 'union',
...
Sbuild::Control::Fields - manage (list of official) control fields
...
CTRL_* constants exported by Sbuild::Control.
...
$from Sbuild::Control object to the $to Sbuild::Control object.
