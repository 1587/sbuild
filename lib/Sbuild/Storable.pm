...
Sbuild::Storable - common methods related to object serialization

=head1 DESCRIPTION

Sbuild::Storable is only meant to be used as parent
...
from Sbuild::Storable so that the methods provided can work.
